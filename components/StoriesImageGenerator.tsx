...
import { ArrowLeftIcon, ClockIcon, DevicePhoneMobileIcon } from '@heroicons/react/24/outline';

interface StoriesImageGeneratorProps {
  onBack: () => void;
}

const StoriesImageGenerator: React.FC<StoriesImageGeneratorProps> = ({ onBack }) => {
  return (
    <div className="py-12 md:py-20 animate-fade-in">
      ...
      <div className="text-center">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-100 flex items-center justify-center gap-3">
            <DevicePhoneMobileIcon className="h-10 w-10 text-blue-400" />
            Gerador de Imagens para Stories
        </h2>
...
export default StoriesImageGenerator;