...
import { ArrowLeftIcon, ClockIcon, PresentationChartLineIcon } from '@heroicons/react/24/outline';

interface PpcAdGeneratorProps {
  onBack: () => void;
}

const PpcAdGenerator: React.FC<PpcAdGeneratorProps> = ({ onBack }) => {
  return (
    <div className="py-12 md:py-20 animate-fade-in">
      ...
      <div className="text-center">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-100 flex items-center justify-center gap-3">
            <PresentationChartLineIcon className="h-10 w-10 text-orange-400" />
            Gerador de Anúncios (PPC)
        </h2>
