...
const ToolCard: React.FC<{ tool: Tool }> = ({ tool }) => {
  return (
    <div className="group relative rounded-xl border border-white/10 bg-slate-800/80 p-6 backdrop-blur-sm transition-all duration-300 hover:bg-slate-700/80 hover:-translate-y-1 hover:shadow-2xl hover:shadow-sky-500/10">
  ...
  return (
    <section id="tools" className="py-16">
      <div className="text-center mb-12">
        <h2 className="text-3xl sm:text-4xl font-bold text-slate-100">Um Ecossistema Completo de Ferramentas</h2>
